    ...
    "articles": [
        {
            ...
            "text": `
Как и любые другие виды спорта и конкурсы, у такого вида конного спорта, как конкур, есть ряд правил и требований к проведению. Путь лошади и ее всадника предполагает дистанцию с барьерами, которую они оба должны проскакать без остановок, не задевая конструкции и удерживаясь верхом. Заранее все препятствия расставляются в четко продуманном порядке, различаясь по ширине и высоте обустройства. 
            <br><br>
Препятствия по ширине — специальные канавы, которые вырыты в ширину от 2,5 до 4 м. Иногда вместо канав могут быть специальные шлагбаумы, который изготавливается из переплетений в виде треугольника.
            <br>
Препятствия по высоте — это могут быть всевозможные барьеры, например, стенка, крестовина, калитка, их высота должна варьировать в пределах 0,8-2,2 м. 
            <br><br>
Лошадь должна преодолеть такие «помехи» без прикосновения к ним, если перед прыжком она сделает дополнительный круг движений, судья начисляет штрафные 4 очка. Если в течение 3-4 попыток животное не справляется с прыжком и отказывается преодолеть барьер, а также в случае падения всадника, команда выбывает из сражения. К тому же руководство состязаний дает каждой команде отрезок времени, за который они должны побороть дистанцию. За каждую лишнюю секунду времени рефери начисляет четверть штрафного балла. Также если всадник и его конь не справятся с отведенным временем, команде грозит дисквалификация.
            `,
        ...
        },
        {
            ...
            "text": `Тренировки, безусловно, очень важны. Если нарушать их последовательность, а также рекомендованные правила проведения, можно не только не добиться нужного результата, но и получить довольно неприятные последствия в виде травм у животного и его плохого состояния. 
<br>
...
Конечно, качество фуража должно быть высоким, чтобы обеспечить животному хорошее восстановление сил и энергии, а также способствовать правильной работе пищеварительной системы.`,
        ...
        },
        {
            ...
            "text": `По правилам с утра перед конкуром всадник и его лошадь должны быть обмундированы в презентабельные наряды. Для этого члены клубов и ассоциаций свою команду снаряжают в специальный костюм, чтобы те легко выделялись во время прохождения дистанции. Если личного костюма нет в наличии, стандартный набор состоит из черного либо синего редингтона, а также белого шарфа для женщины-всадницы, а для мужчины-наездника — алый редингтон и галстук белого цвета. 
            <br>
Если это международные схватки по конкуру, национальную принадлежность можно узнать по оттенку наряда. Например, ирландский всадник снаряжается в зеленый редингтон, в обязательном порядке должны быть кепи синего или черного цвета.
            <br>
Разрешены также хлысты, но не длиннее установленной нормы — 750 мм. Допустимы также шпоры, которые носит всадник, но острые концы их должны смотреть либо вниз, либо в наружную сторону. Обязательное условие ко всем участникам конкура — сапоги специальные для скачек, бриджи и рубашка. Если будет жаркая погода, организаторы могут разрешить не надевать редингтон. Под запретом такие вещи, как рубашка-поло, куртка без рукавов, а также пуловеры. Если предвидится непогода, можно надеть плащ. Если в конкуре участвуют военные либо полицейские, они могут обличить себя в личную форму. Детские конкуры предполагают легкую, практичную и неброскую одежду.`,
    ...
    document.querySelectorAll(".post").forEach(post => {
        post.addEventListener("click", e => {
            ...
            `
                ...
                <button class="downloadButton" onClick="download('${data.title}.txt', \`${data.text.replace(/<br>/g,"")}\`)">
                    Скачать
                </button>
            `
        })
...
function sortOldToNew() {
    dataToShow.articles = dataToShow.articles.sort((a, b) => {
        return Date.parse(a.date) >= Date.parse(b.date) ? 1 : -1
    })
    loadPosts(dataToShow)
}
